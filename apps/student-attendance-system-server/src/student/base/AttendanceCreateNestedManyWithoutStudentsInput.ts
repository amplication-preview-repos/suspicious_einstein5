...
@InputType()
class AttendanceCreateNestedManyWithoutStudentsInput {
...
export { AttendanceCreateNestedManyWithoutStudentsInput as AttendanceCreateNestedManyWithoutStudentsInput };
